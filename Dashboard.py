...
with tab1:
    ...
    col1.markdown(f"<div style='text-align: center;'>Avg Charging Duration</div>", unsafe_allow_html=True)
    ...
    col2.markdown(f"<div style='text-align: center;'>Avg Operating Temp</div>", unsafe_allow_html=True)
    col2.metric("Avg Operating Temp", f"{filtered_df['Battery_Operating_Temperature'].mean():.2f} °C")
    col3.markdown(f"<div style='text-align: center;'>Avg Energy Consumed</div>", unsafe_allow_html=True)
